...
// canvas.GlobalFonts.registerFromPath(`build/structures/font/notosans-kr-black.ttf`, "noto-sans-kr , arabic-font");
canvas.GlobalFonts.registerFromPath(`node_modules/lylacard/build/structures/font/circularstd-black.otf`, "circular-std");
canvas.GlobalFonts.registerFromPath(`node_modules/lylacard/build/structures/font/notosans-jp-black.ttf`, "noto-sans-jp");
canvas.GlobalFonts.registerFromPath(`node_modules/lylacard/build/structures/font/NotoSansArabic-VariableFont_wdth,wght.ttf`, "arabic-font");
canvas.GlobalFonts.registerFromPath(`node_modules/lylacard/build/structures/font/notosans-black.ttf`, "noto-sans");
canvas.GlobalFonts.registerFromPath(`node_modules/lylacard/build/structures/font/notoemoji-bold.ttf`, "noto-emoji");
canvas.GlobalFonts.registerFromPath(`node_modules/lylacard/build/structures/font/Janna LT Bold.ttf`, "noto-sans-kr , arabic-font");
...
class LylaCard {
    ...
    async build() {
        ...
        const selectFontBasedOnLanguage = (text, englishFont) => {
            return isTextArabic(text) ? `75px arabic-font` : englishFont;
        };
        ...
        if (this.theme == 'classic') {
            ...
            ctx.font = selectFontBasedOnLanguage(this.name, `75px circular-std, noto-emoji, noto-sans-jp, noto-sans, noto-sans-kr , arabic-font`);
            ctx.fillText(this.name, 70, 120);

            ctx.fillStyle = '#b8b8b8';
            ctx.font = selectFontBasedOnLanguage(this.author, `50px circular-std, noto-emoji, noto-sans-jp, noto-sans, noto-sans-kr , arabic-font`);
            ...
            ctx.font = selectFontBasedOnLanguage(this.name, "bold 150px circular-std, noto-emoji, noto-sans-jp, noto-sans, noto-sans-kr ,arabic-font");
            ctx.fillStyle = `#${validatedColor}`;
            ctx.fillText(this.name, 800, 350);

            ctx.font = selectFontBasedOnLanguage(this.author, "bold 100px circular-std, noto-emoji, noto-sans-jp, noto-sans, noto-sans-kr , arabic-font");
